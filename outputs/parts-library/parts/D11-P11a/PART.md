...
在下盒壁與撥臂底板之間提供肩銷支承及彈簧導向。

- 狀態：作者設計實際形體，768 三角面，1 個連通體，體積 84.122768 mm³。完整總成及製造認證尚未完成。
- 總成分類：GT01 車輛 → D11 車門外把手 → 把手首件機構 → D11-P11a
- 功能分類：支承 → 滑動軸套
- 單位：mm；保留原生座標。精確軸線與孔軸見 [part.json](part.json)。

![實際形體](references/D11-P11a-model-r1.png)
...
- 長度：8.5 mm；來源 interfaces.axialZ difference
- 軸向 Z：[-14.5,-6] mm；來源 interfaces.axialZ

## 配合與裝入

- [D11-P03](../D11-P03/PART.md)：肩銷 Ø4
- [D11-P02](../D11-P02/PART.md)：下端接下壁
- [D11-P05a](../D11-P05a/PART.md)：上端 Z=-6 接底板
- [D11-P04](../D11-P04/PART.md)：導引圈體

02 裝入下軸套：從前方進入，底端貼合盒體下壁。 唯一動作來源為 [door-handle-assembly-paths.mjs](../../native/source/door-handle-assembly-paths.mjs)。
...
- 尚未完成：依轉動次數選定軸套材料及公差，驗證面壓、磨耗及軸向夾持遊隙。

[本次實際幾何讀回](evidence/native-readback.json) · [整體入口](../../START-HERE.md)

## 圖面適用範圍

- [references/D11-P11a-model-r1.png](references/D11-P11a-model-r1.png) · NATIVE_MODEL_VIEW：同一份模型的正面 +Y、背面 -Y、頂面 +Z、底面 -Z、端面 +X 與斜視；以原生尺寸和孔軸為準。 此圖是局部形體證據，不是承載、密封或完整總成通過。
- [references/D11-P11-r1.png](references/D11-P11-r1.png) · GENERATED_SHAPE_CANDIDATE：只採用下套圖；上套舊長度不可使用。 上套已改為長 11 且從上方裝入；本圖上套退修。

<!-- mathematical-quality -->

## 數學與現實規律怎麼用

[逐件公式、代入與實體讀回](../../math-quality.html#D11-P11a) · [機器資料](../../math-quality.json)
...
- 輸入：`{"originA":[0,0,0],"originB":[-46,-10,-10.25],"unit":"mm"}`
- 讀回：`{"signedVolumeMm3":84.12276760753036,"originDifferenceMm3":3.410605131648481e-13}`
...
- 輸入：`{"id":"D11-P11a","sourceSHA256":"7779e160db32e30166f585662ee0504495ec9399821493241e1ec5194600c9d5"}`
- 讀回：`{"objSHA256":"86c95555c76184a075518a0855ff4677e0746d9552132587aab8739bafb22a28","positionTriangleSHA256":"1a7b3c7d4f8f2597627fd25543b8d87e146c7cbedfaec7ae30ece56c1b729a5d","units":"mm","frameUnits":"mm"}`
...
- 輸入：`{"outerRadiusMm":2.75,"innerRadiusMm":2.1,"lengthMm":8.5}`
- 讀回：`{"observedSides":96,"idealVolumeMm3":84.18290214375548,"polygonVolumeMm3":84.1228128783946,"meshVolumeMm3":84.1227676075307,"numericalErrorMm3":0.00004527086389316537,"polygonDeficitPercent":0.0713794177091609}`
