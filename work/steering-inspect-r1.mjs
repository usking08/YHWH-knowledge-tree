...
record.moduleChecksPass=record.finitePositions&&record.finiteNormals&&record.uniqueIds&&!missing.length&&dimensions[2]<=80&&Math.abs(dimensions[0]-340)<1&&Math.abs(dimensions[1]-340)<1&&record.lowerSlot.open;
await fs.writeFile(new URL('../outputs/quality/steering-native-readback-r1.json',import.meta.url),JSON.stringify(record,null,2));
